...
<a
    ...
    >
        ...
        <span class="min-w-0 flex-1">
            ...
            <span class="block text-sm text-[#64748b] dark:text-[#A1A09A] mt-0.5">{{ __('auth_labels.register_designer') }} →</span>
        </span>
...
@else
    ...
    >
        ...
        <span class="min-w-0 flex-1">
            ...
            <span class="block text-sm text-[#64748b] dark:text-[#A1A09A] mt-0.5">{{ __('auth_labels.register_supplier') }} →</span>
        </span>
        <svg class="w-5 h-5 shrink-0 text-[#f59e0b] opacity-70 group-hover:opacity-100 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
    </a>
@endif
...
<p class="text-base text-center text-[#706f6c] dark:text-[#A1A09A]">
    ...
    <a href="{{ $authAsSupplier ? route('login', ['as' => 'supplier']) : route('login') }}" class="text-base text-[#f53003] dark:text-[#FF4433] hover:underline font-semibold">
        {{ $authAsSupplier ? __('auth_labels.login_supplier') : __('auth_labels.login_designer') }}
    </a>
</p>
