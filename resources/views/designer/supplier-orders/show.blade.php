        ...
        <form id="supplier-order-details-form" method="POST" action="{{ route('supplier-orders.update', $o['id']) }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                    ...
                    <select name="project_id" required disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
                ...
                <div>
                    ...
                    <select name="supplier_id" required disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
                ...
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.amount') }}</div><input type="number" name="summa" value="{{ $o['summa'] ?? 0 }}" required min="0" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.category') }}</div><select name="category" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"><option value=""></option>@foreach (($categoryOptions ?? []) as $key => $name)<option value="{{ $key }}" @selected(($o['category'] ?? '') === $key)>{{ $name }}</option>@endforeach</select></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.room') }}</div><select name="room" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"><option value=""></option>@foreach (($roomOptions ?? []) as $key => $name)<option value="{{ $key }}" @selected(($o['room'] ?? '') === $key)>{{ $name }}</option>@endforeach</select></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.mark_on_drawing') }}</div><input name="mark" value="{{ $o['mark'] ?? '' }}" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.planned_delivery_date') }}</div><input type="date" name="date_planned" value="{{ $o['date_planned'] ?? '' }}" required disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.actual_delivery_date') }}</div><input type="date" name="date_actual" value="{{ $o['date_actual'] ?? '' }}" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.advance_date') }}</div><input type="date" name="prepayment_date" value="{{ $o['prepayment_date'] ?? '' }}" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('supplier-orders.balance_date') }}</div><input type="date" name="payment_date" value="{{ $o['payment_date'] ?? '' }}" disabled class="w-full px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]"></div>
