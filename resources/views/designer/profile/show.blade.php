    ...
    <div class="space-y-6">
        ...
        <section class="bg-white dark:bg-[#161615] border border-[#7c8799] dark:border-[#3E3E3A] rounded-xl p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('settings.vk') }}</div><div>{{ $profile?->vk ?: '-' }}</div></div>
                <div><div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('settings.instagram') }}</div><div>{{ $profile?->instagram ?: '-' }}</div></div>
            </div>
        </section>
