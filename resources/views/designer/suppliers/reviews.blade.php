...
@section('content')
    ...
    <div class="mb-6 flex items-center justify-between gap-3 flex-wrap">
        ...
        <a href="{{ route('suppliers.index') }}" class="px-4 py-2 rounded-lg border border-[#7c8799] dark:border-[#3E3E3A] text-sm text-[#64748b] dark:text-[#A1A09A] hover:border-[#f59e0b] hover:text-[#f59e0b] transition-colors">
            {{ __('suppliers.close') }}
        </a>
    </div>
