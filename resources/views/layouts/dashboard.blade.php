...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] dark:text-[#EDEDEC] transition-colors duration-200">
    @php
        ...
        if (! $isModerator && auth()->check() && $hasSubscriptionAccess) {
            $uid = (int) auth()->id();
        ...
        <div class="flex flex-col h-full">
            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                ...
                @else
                    ...
                    <a href="{{ route('dashboard') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('dashboard') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                    ...
                    @if (Route::has('projects.index'))
                        <a href="{{ route('projects.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('projects.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (Route::has('tasks.index'))
                        <a href="{{ route('tasks.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('tasks.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>
                            <span>{{ __('tasks.title') }}</span>
                        </a>
                    @endif
                    @if (Route::has('clients.index'))
                        <a href="{{ route('clients.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('clients.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (Route::has('suppliers.index'))
                        <a href="{{ route('suppliers.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('suppliers.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    @if (Route::has('community.index'))
                        <a href="{{ route('community.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('community.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                    ...
                    @if (Route::has('subscription.index') && $isDesigner)
                        <a href="{{ route('subscription.index') }}"
                            class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('subscription.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a]' : '' }}">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/>
                            </svg>
                            <span class="flex-1">{{ __('subscription.title') }}</span>
                            @php
                                $subStatus = \App\Support\DesignerSubscription::status(auth()->user());
                            @endphp
                            @if ($subStatus === 'trial')
                                <span class="text-[10px] font-medium text-[#f59e0b]">{{ __('subscription.status_trial') }}</span>
                            @elseif (in_array($subStatus, ['expired', 'none'], true))
                                <span class="inline-flex items-center justify-center min-w-5 h-5 px-1.5 rounded-full text-[10px] bg-[#f59e0b] text-white">!</span>
                            @endif
                        </a>
                    @endif
            ...
            <div class="p-4 border-t border-[#7c8799] dark:border-[#3E3E3A] space-y-2">
                ...
                <button id="theme-toggle" type="button"
                    ...
                    title="{{ __('dashboard.theme_toggle') }}">
                    ...
                    <span id="theme-text" class="dark:hidden">{{ __('dashboard.dark_theme') }}</span>
                    <span id="theme-text-light" class="hidden dark:inline">{{ __('dashboard.light_theme') }}</span>
                </button>
                ...
                <!-- Профиль — только при активной подписке -->
                @if ($hasSubscriptionAccess && Route::has('profile.show'))
    ...
    <div class="lg:ml-64 min-h-screen">
        ...
        <!-- Контент -->
        <main class="p-4 sm:p-6 @yield('main_class')">
            @yield('content')
        </main>
    </div>
