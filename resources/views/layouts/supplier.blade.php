            ...
            <nav class="flex-1 p-4 overflow-y-auto">
                ...
                @if (Route::has('community.index'))
                    <a href="{{ route('community.index') }}"
                        class="flex items-center gap-3 px-4 py-2 rounded-lg text-[#1b1b18] dark:text-[#EDEDEC] hover:bg-[#FDFDFC] dark:hover:bg-[#0a0a0a] transition-colors mb-1 {{ request()->routeIs('community.*') ? 'bg-[#FDFDFC] dark:bg-[#0a0a0a] ring-1 ring-[#f59e0b]/40' : '' }}">
