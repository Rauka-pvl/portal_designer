        ...
        <div class="bg-white dark:bg-[#161615] border border-[#7c8799] dark:border-[#3E3E3A] rounded-lg overflow-hidden">
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody id="objects-table-body" class="divide-y divide-[#7c8799] dark:divide-[#3E3E3A]">
                            ...
                            <div class="funnel-card" draggable="true"
                                ...
                                <div class="flex items-center gap-2 mt-2" onclick="event.stopPropagation()">
                                    <button type="button"
                                        ...
                                        class="text-xs px-2 py-1 rounded border border-[#7c8799] dark:border-[#3E3E3A] text-[#64748b] dark:text-[#A1A09A] hover:border-[#f59e0b] hover:text-[#f59e0b] transition-colors">{{ __('objects.view') }}</button>
                                    <button type="button"
                                        onclick="event.stopPropagation(); editObject({{ $object['id'] }})"
                                        class="text-xs px-2 py-1 rounded border border-[#7c8799] dark:border-[#3E3E3A] text-[#64748b] dark:text-[#A1A09A] hover:border-[#f59e0b] hover:text-[#f59e0b] transition-colors">{{ __('objects.edit') }}</button>
                                </div>
                            </div>
                        @endif
                    @endforeach
        ...
        function viewObject(id) {
            ...
            if (obj) {
                ...
                const typeText = obj.type === 'apartment' ? '{{ __('objects.apartment') }}' :
                    ...
                    '{{ __('objects.other') }}';
                content.innerHTML = `
            <div class="p-4 rounded-lg bg-[#f8fafc] dark:bg-[#0a0a0a] border border-[#7c8799] dark:border-[#3E3E3A]">
