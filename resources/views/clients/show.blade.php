                            ...
                            @foreach ($filePaths as $path)
                                <div class="flex flex-wrap items-center gap-2">
                                    ...
                                    <button type="button"
                                        ...
                                        class="edit-only-control hidden p-1.5 rounded border border-[#7c8799] dark:border-[#3E3E3A] text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-500 hover:text-red-600 transition-colors"
