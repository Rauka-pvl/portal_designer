...
@section('content')
    ...
    <div class="panel space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="p-4 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-[#f8fafc] dark:bg-[#0a0a0a]">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
                ...
                <input disabled value="{{ $object->city ?? '' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
            <div>
                <div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('suppliers.address') }}</div>
                <input disabled value="{{ $object->address ?? '' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
            <div>
                <div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('objects.type') }}</div>
                <input disabled value="{{ $object->type ?? '-' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
            <div>
                <div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('objects.apartment_number') }}</div>
                <input disabled value="{{ $object->apartment ?? '-' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
            <div>
                <div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('objects.apartment_entrance') }}</div>
                <input disabled value="{{ $object->apartment_entrance ?? '-' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
            <div>
                <div class="text-sm text-[#64748b] dark:text-[#A1A09A] mb-1">{{ __('objects.apartment_floor') }}</div>
                <input disabled value="{{ $object->apartment_floor ?? '-' }}" class="w-full px-4 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] bg-white dark:bg-[#161615]">
            </div>
        </div>
