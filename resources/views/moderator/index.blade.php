                    ...
                    @foreach($pendingObjects as $o)
                        ...
                        <div class="p-4 border border-[#e2e8f0] dark:border-[#3E3E3A] rounded-lg bg-[#f8fafc] dark:bg-[#0a0a0a]">
                            <div class="flex items-start justify-between gap-3">
                                ...
                                <a href="{{ route('moderator.objects.show', $o->id) }}" class="px-3 py-2 rounded-lg border border-[#e2e8f0] dark:border-[#3E3E3A] text-[#f59e0b] dark:text-[#f59e0b] hover:bg-[#fef3c7] dark:hover:bg-[#1D0002] transition-colors text-sm whitespace-nowrap">
                                    {{ __('moderation.review') }}
                                </a>
                            </div>
                        </div>
